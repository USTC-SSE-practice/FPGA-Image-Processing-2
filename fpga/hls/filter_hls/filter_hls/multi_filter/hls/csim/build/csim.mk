...
HLS_SOURCES = ../../../../../../testbench.cpp ../../../../../../multi_filter.cpp
...
$(ObjDir)/multi_filter.o: ../../../../../../multi_filter.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../multi_filter.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/multi_filter.d
