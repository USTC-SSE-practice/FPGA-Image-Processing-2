; ModuleID = 'C:/Image_Processing_FPGA/fpga/hls/filter_hls/filter_hls/multi_filter/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_multi_filter_ir(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(7) %in_stream, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(7) %out_stream, i32 %rows, i32 %cols) local_unnamed_addr #0 {
entry:
...
declare void @apatb_multi_filter_hw(i8*, i1*, i1*, i1*, i1*, i1*, i1*, i8*, i1*, i1*, i1*, i1*, i1*, i1*, i32, i32)
...
declare void @multi_filter_hw_stub(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* noalias nonnull, i32, i32)

define void @multi_filter_hw_stub_wrapper(i8*, i1*, i1*, i1*, i1*, i1*, i1*, i8*, i1*, i1*, i1*, i1*, i1*, i1*, i32, i32) #5 {
entry:
  ...
  call void @multi_filter_hw_stub(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* %17, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* %19, i32 %14, i32 %15)
