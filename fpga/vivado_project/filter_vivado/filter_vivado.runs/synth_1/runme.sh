...
HD_PWD='C:/Image_Processing_FPGA/fpga/vivado_project/filter_vivado/filter_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter_bd_wrapper.tcl
