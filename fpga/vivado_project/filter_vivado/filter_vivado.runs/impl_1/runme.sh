...
HD_PWD='C:/Image_Processing_FPGA/fpga/vivado_project/filter_vivado/filter_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source filter_bd_wrapper.tcl -notrace
