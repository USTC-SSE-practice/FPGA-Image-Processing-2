...
HD_PWD='C:/Image_Processing_FPGA/fpga/vivado_project/filter_vivado/filter_vivado.runs/filter_bd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_bd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter_bd.tcl
