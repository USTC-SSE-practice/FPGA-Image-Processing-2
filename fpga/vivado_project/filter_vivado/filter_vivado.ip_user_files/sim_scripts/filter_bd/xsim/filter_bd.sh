...
#
# Script generated by Vivado on Thu Jun 26 01:41:06 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : filter_bd.sh
...
#
# Usage        : filter_bd.sh
#                filter_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                filter_bd.sh [-reset_run]
#                filter_bd.sh [-reset_log]
#                filter_bd.sh [-help]
#
...
# script info
echo -e "filter_bd.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./filter_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb filter_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./filter_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: filter_bd.sh [-help]\n\
Usage: filter_bd.sh [-step]\n\
Usage: filter_bd.sh [-lib_map_path]\n\
Usage: filter_bd.sh [-reset_run]\n\
Usage: filter_bd.sh [-reset_log]\n\
Usage: filter_bd.sh [-keep_index]\n\
Usage: filter_bd.sh [-noclean_files]\n\n\
