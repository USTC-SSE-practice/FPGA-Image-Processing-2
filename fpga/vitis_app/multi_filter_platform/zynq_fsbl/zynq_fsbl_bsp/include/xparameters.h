...
#define XPAR_XMULTI_FILTER_NUM_INSTANCES 1

/* Definitions for peripheral MULTI_FILTER_0 */
#define XPAR_MULTI_FILTER_0_COMPATIBLE "xlnx,multi-filter-1.0"
#define XPAR_MULTI_FILTER_0_BASEADDR 0x40000000
#define XPAR_MULTI_FILTER_0_HIGHADDR 0x4000ffff

/* Canonical definitions for peripheral MULTI_FILTER_0 */
#define XPAR_XMULTI_FILTER_0_BASEADDR 0x40000000
#define XPAR_XMULTI_FILTER_0_HIGHADDR 0x4000ffff
#define XPAR_XMULTI_FILTER_0_COMPATIBLE "xlnx,multi-filter-1.0"
